FACTOR_VERSION := $(shell cat FACTOR_VERSION)
FACTOR_DEPS := $(wildcard FACTOR_*)
DOCKER_TAG_PREFIX := rzuckerm/factor:$(FACTOR_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(FACTOR_DEPS)
